        ...
        <div className="vaccineUpperNavigationLinks">
           <div className="container-fluid">
            <div className="setLinks">
                ...
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/rna-based-vaccine/biontech-pfizer-fosun-pharma-rentschler-biopharma'}>Pfizer</Link></button>
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/rna-based-vaccine/moderna-niaid-lonza-catalent-rovi-medidata-bioqual'}>Moderna</Link></button>
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/non-replicating-viral-vector/university-of-oxford-oxford-biomedica,-vaccines-manufacturing-and-innovation-centre,-pall-life-sciences,-cobra-biologics,-halixbv,-advent-s.r.l.,-merck-kgaa,-the-serum-institute,-vaccitech,-catalent,-csl,-and-astrazenecaiqvia'}>Oxford</Link></button>
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/non-replicating-viral-vector/gamaleya-research-institute'}>Sputnik 5</Link></button>
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/non-replicating-viral-vector/cansino-biologics-beijing-institute-of-biotechnology-petrovax'}>CanSino Biologics</Link></button>
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/inactivated-virus/sinovac-instituto-butantan-bio-farma'}>Sinovac</Link></button>
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/protein-subunit/novavaxemergent-biosolutions-praha-vaccines-biofabri-fujifilm-diosynth-biotechnologies-fdb-serum-institute-of-india-sk-bioscience-takeda-pharmaceutical-company-limited-agc-biologics-polypeptide-group-endo'}>Noravax</Link></button>
                <button type="button" className="marginSet btn btn-dark" style={{fontWeight:'bold'}} ><Link className="setLinkColor" to={'/Treatment-Information/inactivated-virus/beijing-institute-of-biological-products-sinopharm'}>Wuhan</Link></button>
